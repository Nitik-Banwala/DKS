        ...
        <section className="bg-[#F9F8F5] py-14 md:py-20 lg:py-25 xl:py-30 px-6">
            <div className="max-w-285 mx-auto">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start mb-12.5 gap-6 lg:gap-0">
                    <h2 className="text-3xl md:text-5xl font-semibold Poppins leading-120 max-w-[451.1px]">
                        Upholstery Tips,{" "}
                        <br />
                        <span className="text-green">Care & Inspiration</span>
                    </h2>
                    <p className="text-base leading-160 font-normal Poppins text-body-text max-w-[427.1px]">
                    ...
                    {blogsdata.map((item, index) => (
                        index % 2 === 0 ? (
                            ...
                            <div key={index} className="bg-white rounded-2xl p-8 flex flex-col justify-between h-[310.1px]">
                                <div>
                                    <h3 className="font-semibold text-xl Poppins text-blacky mb-3">
                                        {item.title}
                                    </h3>
                                    <p className="text-base font-normal leading-160 Poppins text-body-text">
                                        {item.description}
                                    </p>
                                </div>
                                <a
                ...
                <div className="flex justify-center mt-10">
                    <Button
                        text={'Show More'}
                        className="bg-green text-white font-semibold text-base Poppins w-[145.1px] h-12.5 rounded-full transition-colors duration-300 hover:bg-whity hover:border hover:border-green hover:text-green active:bg-green active:text-white"
                    />
                </div>
